...
cdef extern from "simpulse_cython.hpp" namespace "simpulse":
    ...
    void _get_signal_to_noise_scalar(single_pulse *sp, double sample_dt, double sample_t0, double sample_rms) except +
    void _get_signal_to_noise_vector(single_pulse *sp, const double *sample_rms, double sample_dt, double sample_t0) except +
